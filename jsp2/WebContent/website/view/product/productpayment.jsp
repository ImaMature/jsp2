...
<body>
	...
	<%
		...
		System.out.print(member.getM_address());
		// 회원주소 불러오기
	...
	<div class="container">
		...
		<table class="table">
			<tr class="text-center"> <th>이미지</th><th>상품정보</th><th>수량</th><th>가격</th>
			<%
			for(Cart cart : carts){
		...
		<div class="row">
			...
			<div class="col-md-6 border p-3">
				...
				<h6>결제 내용</h6>
				<div class="row">
					<div class="col-md-3 m-2"> <label>마일리지<br></label></div>
					<div class="col-md-6">
						 <input type="text" id="point" placeholder="사용할 포인트" class="form-control">
						<br>사용가능 마일리지 : <%=member.getM_point() %>
					</div>
					<div class="col-md-2">
						<button class="btn btn-outline-primary" onclick="pointcheck('<%=member.getM_point()%>')">사용</button> 
					</div>
				</div>
				<hr>
				...
				<h6>결제 금액</h6> 
					<div class="row">
						...
						<div class="col-md-9 text-right"> 
							배송비 : <span id = "totaldeliverypay" class="payment">3000</span>
						</div>
						<div class="col-md-3">사용한 포인트</div>
						<div class="col-md-9 text-right" class="payment"> 
